...
RSpec.describe CommentsController, type: :controller do
  ...
  context "guest" do
    describe "POST create @post comment" do
    ...
    describe "DELETE destroy @post comment" do
      it "redirects the user to the sign in view" do
    ...
    describe "POST create @topic comment" do
      it "redirects the user to the sign in view" do
    ...
    describe "DELETE destroy @topic comment" do
      it "redirects the user to the sign in view" do
  ...
  context "member user going CRUD on a comment they don't own" do
    before do
  ...
  context "member user doing CRUD on a @post comment they own" do
    before do
